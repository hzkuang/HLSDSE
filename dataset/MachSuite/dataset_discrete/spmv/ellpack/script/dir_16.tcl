...
set_directive_unroll -factor 2 ellpack/ellpack_2
set_directive_pipeline -off ellpack/ellpack_2
...
set_directive_array_partition -factor 2 -type block ellpack vec
set_directive_array_reshape -factor 2 -type block ellpack vec
set_directive_array_partition -factor 2 -type block ellpack out
set_directive_array_reshape -factor 2 -type cyclic ellpack out
