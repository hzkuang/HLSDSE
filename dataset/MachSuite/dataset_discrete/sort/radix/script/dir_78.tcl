set_directive_inline -off init
set_directive_inline -recursive hist
set_directive_inline -off local_scan
set_directive_inline -recursive sum_scan
set_directive_inline -off last_step_scan
...
set_directive_pipeline -style stp last_step_scan/last_1
...
set_directive_array_reshape -factor 2 -type block ss_sort b
set_directive_array_partition -factor 2 -type block ss_sort bucket
set_directive_array_reshape -factor 2 -type cyclic ss_sort bucket
set_directive_array_partition -factor 2 -type block ss_sort sum
set_directive_array_reshape -factor 2 -type cyclic ss_sort sum
...
set_directive_bind_op -op add -impl fabric -latency -1 hist/hist_1 blockID
...
set_directive_bind_op -op add -impl fabric -latency -1 sum_scan/sum_1 radixID
...
set_directive_bind_op -op mul -impl dsp -latency -1 update/update_2 bucket_indx
