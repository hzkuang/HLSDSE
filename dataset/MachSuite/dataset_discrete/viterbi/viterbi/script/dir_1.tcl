...
set_directive_unroll -factor 2 viterbi/L_prev_state
set_directive_pipeline -style stp viterbi/L_prev_state
set_directive_array_partition -factor 2 -type block viterbi llike
set_directive_array_reshape -factor 2 -type cyclic viterbi llike
...
set_directive_array_reshape -factor 2 -type cyclic viterbi transition
set_directive_array_partition -factor 2 -type block viterbi emission
set_directive_array_reshape -factor 2 -type block viterbi emission
set_directive_array_partition -factor 2 -type block viterbi path
