...
set_directive_pipeline -style stp gemm/inner
set_directive_array_partition -factor 2 -type block gemm m1
set_directive_array_reshape -factor 2 -type cyclic gemm m1
set_directive_array_partition -factor 2 -type cyclic gemm m2
set_directive_array_reshape -factor 2 -type cyclic gemm m2
set_directive_array_partition -factor 2 -type cyclic gemm prod
set_directive_array_reshape -factor 2 -type block gemm prod
set_directive_bind_op -op add -impl fabric -latency -1 gemm/outer i
set_directive_bind_op -op add -impl fabric -latency -1 gemm/middle j
...
set_directive_bind_op -op mul -impl fabric -latency -1 gemm/inner k_col
set_directive_bind_op -op dadd -impl fabric -latency -1 gemm/inner sum
set_directive_bind_op -op dmul -impl fabric -latency -1 gemm/inner mult
