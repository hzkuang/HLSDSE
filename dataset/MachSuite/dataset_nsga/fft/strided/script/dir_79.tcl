...
set_directive_array_partition -factor 2 -type cyclic fft real
set_directive_array_reshape -factor 2 -type cyclic fft real
set_directive_array_partition -factor 2 -type block fft img
set_directive_array_reshape -factor 2 -type cyclic fft img
set_directive_array_reshape -factor 2 -type cyclic fft real_twid
set_directive_array_partition -factor 2 -type cyclic fft img_twid
set_directive_array_reshape -factor 2 -type cyclic fft img_twid
