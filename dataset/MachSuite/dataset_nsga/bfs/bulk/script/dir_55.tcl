...
set_directive_array_reshape -factor 2 -type cyclic bfs nodes
set_directive_array_partition -factor 2 -type block bfs level
set_directive_array_partition -factor 2 -type block bfs level_counts
set_directive_array_reshape -factor 2 -type cyclic bfs level_counts
