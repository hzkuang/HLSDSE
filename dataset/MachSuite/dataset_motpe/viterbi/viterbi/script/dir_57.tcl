...
set_directive_unroll -factor 2 viterbi/L_state
...
set_directive_bind_storage -type fifo -impl bram -latency -1 viterbi llike
set_directive_array_partition -factor 2 -type cyclic viterbi obs
set_directive_array_partition -factor 2 -type cyclic viterbi init
